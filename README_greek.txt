...
3) Η δημιουργία του καταλόγου προς αντιγραφή <directory> γίνεται μέσα σε έναν άλλο φάκελο "output" (build/release/output/)
   τον οποίο κάνω define στο 'remoteClient.hpp'.
